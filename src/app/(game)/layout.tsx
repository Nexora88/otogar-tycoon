...
export default function GameLayout({
    ...
    <>
      {menuItems.map((item) => {
        ...
        return (
          ...
          >
            <Icon
              className={`w-4 h-4 shrink-0 ${active ? "text-amber-400" : ""}`}
            />
            {item.label}
          </Link>
        );
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#0a0a0b] text-zinc-100">
        ...
        >
          ...
          >
            ...
            <div className="border-t border-zinc-800 pt-3 text-xs text-zinc-500 space-y-1">
              ...
              <Link
                href="/"
                className="flex items-center gap-2 text-zinc-500 pt-2"
              >
      ...
      <nav className="md:hidden fixed bottom-0 inset-x-0 z-30 border-t border-zinc-800 bg-[#0a0a0b]/95 backdrop-blur flex justify-around py-2">

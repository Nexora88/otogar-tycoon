...
export default function GameLayout({
  ...
  return (
    <div className="min-h-screen flex bg-[#0a0a0b] text-zinc-100">
      <aside className="w-60 md:w-64 border-r border-zinc-800 flex flex-col shrink-0">
        <div className="p-4 border-b border-zinc-800 flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="font-bold text-sm truncate">Otogar Tycoon</div>
        ...
        <div className="p-4 border-b border-zinc-800">
          <div className="text-[10px] text-zinc-500 mb-0.5">Şirket</div>
          <div className="font-medium text-sm truncate">{companyName}</div>
          {isGuest && (
            <div className="mt-1 text-[10px] text-amber-500/90">Misafir</div>
          )}
        </div>
        ...
        <div className="p-4 border-t border-zinc-800 space-y-2">
          ...
          <div>
            <div className="text-[10px] text-zinc-500">İtibar</div>
            <div className="text-sm">{reputation}/100</div>
          </div>
          {bankDebt > 0 && (
          ...
          <Link
            href="/"
            className="flex items-center gap-2 text-xs text-zinc-500 hover:text-red-400 pt-2"
          >

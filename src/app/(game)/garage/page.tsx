          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <div className="flex justify-center mb-6">
              <div
                ...
                style={{ transform: "perspective(400px) rotateY(-8deg)" }}
              >
                <div
                  className={`absolute inset-0 rounded-lg border border-black/40 bg-gradient-to-br ${
                    bus.color === "blue"
            ...
            <div className="text-center mb-4">
              <div className="inline-block bg-white text-black font-mono text-xl font-bold px-4 py-1.5 rounded border-[3px] border-black tracking-[0.2em]">
                {bus.plate || "34 YOK 00"}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="bg-zinc-950 rounded-lg p-3 border border-zinc-800">
                ...
                <div className="font-semibold">{formatMoney(bus.muavinCost || 400)}</div>
              </div>
              <div className="bg-zinc-950 rounded-lg p-3 border border-zinc-800">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
            ...
            <div className="text-xs text-zinc-500 mb-3">
              ...
              <span className="font-mono text-zinc-300">
                {plateCity} {plateMid || "???"} {plateNum || "??"}
              </span>
            </div>
            <button
              type="button"
              onClick={applyPlate}
              className="px-5 py-2.5 bg-amber-500 text-black font-semibold rounded-xl hover:bg-amber-400 text-sm"
            >
              Plakayı onayla
            </button>
          </div>
